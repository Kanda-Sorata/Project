...
/**
 * This interface contains methods that are considered the "vendor extension" to the JDBC API for MySQL's implementation of java.sql.DataConnection.
 * 
...
public interface Connection extends java.sql.Connection, ConnectionProperties {
     ...
     * with the same semantics as the java.sql.DataConnection.prepareStatement()
     ...
     * @deprecated replaced by <code>DataConnection.getServerCharset()</code>
     */
    @Deprecated
     ...
     * as the java.sql.DataConnection.prepareStatement() method with the
     * same argument types.
     * 
     * @see java.sql.Connection#prepareStatement(String)
     */
