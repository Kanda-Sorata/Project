...
/**
 * A DataConnection represents a session with a specific database. Within the context of a DataConnection, SQL statements are executed and results are returned.
 * 
 * <P>
 * A DataConnection's database is able to provide information describing its tables, its supported SQL grammar, its stored procedures, the capabilities of this
...
public class ConnectionImpl extends ConnectionPropertiesImpl implements MySQLConnection {
     ...
     * java.sql.DataConnection.TRANSACTION_XXX
     */
    ...
    /** Point of origin where this DataConnection was created */
    ...
    /**
     * In some cases, it is desirable to immediately release a DataConnection's
     * database and JDBC resources instead of waiting for them to be
     * automatically released (cant think why off the top of my head) <B>Note:</B>
     * A DataConnection is automatically closed when it is garbage collected.
     ...
     * by the DataConnection. This method should only be used when auto-commit has
     * been disabled.
     * <p>
    ...
    /**
     * Get this DataConnection's current transaction isolation mode.
     * 
    ...
    /**
     * The first warning reported by calls on this DataConnection is returned.
            ...
            if (this.serverVariables.containsKey("max_allowed_packet")) {
                ...
                if (getUseServerPrepStmts()) {
                    ...
                    if (allowedBlobSendChunkSize <= 0) {
                        throw SQLError.createSQLException(
                                "DataConnection setting too low for 'maxAllowedPacket'. "
    ...
    public void realClose(boolean calledExplicitly, boolean issueRollback, boolean skipLocalTeardown, Throwable reason) throws SQLException {
        ...
        try {
            if (!skipLocalTeardown) {
                ...
                if (getUseUsageAdvisor()) {
                    if (!calledExplicitly) {
                        String message = "DataConnection implicitly closed by Driver. You should call DataConnection.close() from your code to free resources more efficiently and avoid resource leaks.";
                    ...
                    if (connectionLifeTime < 500) {
                        String message = "DataConnection lifetime of < .5 seconds. You might be un-necessarily creating short-lived connections and should investigate connection pooling to be more efficient.";
    ...
    /**
     * A sub-space of this DataConnection's database may be selected by setting a
