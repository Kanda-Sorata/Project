...
public interface ConnectionLifecycleInterceptor extends Extension {
    /**
     * Called when an application calls DataConnection.close(), before the driver
    ...
    /**
     * Called when an application calls DataConnection.commit(), before the
    ...
    /**
     * Called when an application calls DataConnection.rollback(), before the
    ...
    /**
     * Called when an application calls DataConnection.setAutoCommit(), before the
    ...
    /**
     * Called when an application calls DataConnection.setCatalog(), before the
