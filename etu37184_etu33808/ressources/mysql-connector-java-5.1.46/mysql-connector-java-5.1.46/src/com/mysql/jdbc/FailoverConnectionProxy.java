...
/**
 * A proxy for a dynamic com.mysql.jdbc.DataConnection implementation that provides failover features for list of hosts. DataConnection switching occurs on
    ...
    private synchronized void connectTo(int hostIndex) throws SQLException {
        try {
            ...
            if (this.currentConnection != null) {
                StringBuilder msg = new StringBuilder("DataConnection to ").append(isPrimaryHostIndex(hostIndex) ? "primary" : "secondary").append(" host '")
