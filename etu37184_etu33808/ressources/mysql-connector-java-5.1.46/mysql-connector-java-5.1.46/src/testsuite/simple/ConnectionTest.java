...
/**
 * Tests java.sql.DataConnection functionality
 */
public class ConnectionTest extends BaseTestCase {
    ...
    public void testIsolationLevel() throws Exception {
        if (versionMeetsMinimum(4, 0)) {
            ...
            String[] isoLevelNames = new String[] { "DataConnection.TRANSACTION_NONE", "DataConnection.TRANSACTION_READ_COMMITTED",
                    "DataConnection.TRANSACTION_READ_UNCOMMITTED", "DataConnection.TRANSACTION_REPEATABLE_READ", "DataConnection.TRANSACTION_SERIALIZABLE" };
    ...
    public void testFailoverConnection() throws Exception {
        ...
        if (!isServerRunningOnWindows()) { // windows sockets don't work for this test
            ...
            try {
                ...
                System.out.println("Original DataConnection Id = " + originalConnectionId);

                assertTrue("DataConnection should not be in READ_ONLY state", !failoverConnection.isReadOnly());
                ...
                System.out.println("new DataConnection Id = " + newConnectionId);

                assertTrue("We should have a new connection to the server in this case", !newConnectionId.equals(originalConnectionId));
                assertTrue("DataConnection should not be read-only", !failoverConnection.isReadOnly());
            } finally {
    ...
    public void testSelfDestruct() throws Exception {
        ...
        if (!failed) {
            fail("DataConnection should've self-destructed");
        }
